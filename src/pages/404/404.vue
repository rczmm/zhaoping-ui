...
function addText() {
  ...
  loader.load('https://threejs.org/examples/fonts/helvetiker_regular.typeface.json', font => {
    ...
    const intelligent = new TextGeometry('you lose', fontSettings)
    const drumAndBass = new TextGeometry('not found the page', fontSettings)
    const vol2 = new TextGeometry('404', fontSettings)
